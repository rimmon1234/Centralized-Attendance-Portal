...
const DEPARTMENTS = [
  ...
  { code: 'AEIE', name: 'Applied Electronics & Instrumentation Engineering' },
  { code: 'CSBS', name: 'Computer Science & Business Systems' },
  { code: 'CSDS', name: 'Computer Science & Data Science' },
              ...
              {!viewType ? (
                ...
                <div className="px-6 py-6">
                  ...
                  <div className="flex gap-2 mb-6">
                    <button
                      onClick={() => fetchDepartmentTeachers(selectedDept.code)}
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${viewType === 'teachers'
                    ...
                    <button
                      onClick={() => fetchDepartmentStudents(selectedDept.code)}
                      className={`px-4 py-2 rounded-lg text-sm font-medium transition-colors ${viewType === 'students'
                          ...
                          .map(([year, students]) => (
                            <div key={year}>
                              <h4 className="text-sm font-semibold text-gray-900 dark:text-white mb-3 pb-2 border-b border-gray-200 dark:border-gray-700">
                                {formatYearSection(year)} ({students.length} students)
                              </h4>
